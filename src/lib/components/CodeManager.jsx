...
function CodeManager() {
  ...
  const [newCode, setNewCode] = useState({ name: '', description: '', color: '#cccccc' });
  ...
  const handleAddNewCode = () => {
    ...
    setNewCode({ name: '', description: '', color: '#cccccc' });
    setAddingNew(false);
  };
                    ...
                    <div className="flex items-center flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          onKeyDown={handleKeyPress}
                          className="font-semibold text-sm border rounded px-1 py-0.5 w-full mb-0.5"
